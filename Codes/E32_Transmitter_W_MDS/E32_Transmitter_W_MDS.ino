...
//Magnetic Door Switch Variables
const int sensor = 2; //D2
int state = HIGH; // 0 close - 1 open Switch
...
//random(0x81, 0xFF)
  uint8_t SendBuf[4] = { DEVICE_A_ADDR_H, DEVICE_A_ADDR_L, 0x17, 0x88};	//for B
